...
<script>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/all.min.css" />
	...
	<h1><center>
	<h1><div style="margin-left:3%;position:fixed;color:#fffff;font-size:30px" >Matematik Dersi</div></h1>
...
&nbsp;&nbsp;
<i onclick="gizleGoster('zamanbaslas');" style="color:white;" class=" btn fas fa-solid fa-clock fa-1x"></i>
&nbsp;&nbsp;
